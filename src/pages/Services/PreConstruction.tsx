...
interface PreConstructionProps {
  onOpenContact: () => void;
}

export const PreConstruction: React.FC<PreConstructionProps> = ({ onOpenContact }) => {
  ...
  return (
    <div className="pt-0 pb-0 bg-white selection:bg-[#FA6400] selection:text-white">
      ...
      {/* ──────────────────────────────────────────────────────── */}
      {/* 1. HERO — "Services" / "Pre-Construction"                */}
      {/* ──────────────────────────────────────────────────────── */}
      <section className="bg-white overflow-hidden">
          ...
          <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-end">
            ...
            <div className="lg:col-span-6 flex items-end lg:pl-10 xl:pl-16 pb-1">
              <p className="font-titillium text-[14px] sm:text-[14.5px] lg:text-[15px] text-[#222222] leading-[1.6] max-w-[480px]">
                From early feasibility study to virtual coordination, we set up your project for complete execution success.
              </p>
            </div>
          </div>
        </Container>
        ...
        <div className="w-full h-[320px] sm:h-[400px] lg:h-[480px] xl:h-[520px] overflow-hidden group/hero cursor-pointer">
          <img
            ...
            alt="White modern architectural building design facade"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-20 items-center">
            ...
            <div className="lg:col-span-6 flex flex-col justify-center space-y-6 pr-0 lg:pr-8">
              <h2 className="font-titillium text-[32px] sm:text-[40px] lg:text-[50px] xl:text-[56px] 2xl:text-[62px] font-normal text-[#0A0909] leading-[1.12] tracking-[-0.015em] mb-4">
                Proactive project planning that ensures certainty of cost, schedule and quality
              </h2>
              <p className="font-titillium text-[15px] sm:text-[17px] lg:text-[18px] 2xl:text-[20px] text-neutral-500 leading-[1.75] max-w-[580px]">
                A successful build is decided before ground is ever broken. Our comprehensive pre-construction workflow evaluates materials, site logistics, staging scenarios, and code requirements to prevent surprises.
              </p>
            </div>
            ...
            <div className="lg:col-span-6 overflow-hidden h-[350px] sm:h-[450px] lg:h-[550px] xl:h-[600px] 2xl:h-[650px]">
              <img
                ...
                alt="New York cityscape and buildings skyline"
          ...
          <div className="space-y-10">
            ...
            <div className="max-w-[950px]">
              <h2 className="font-titillium text-[24px] sm:text-[28px] lg:text-[34px] xl:text-[38px] 2xl:text-[42px] font-normal leading-[1.28] tracking-[-0.01em] text-[#0A0909] mb-2">
                We coordinate every trade and analyze every cost line to ensure your project's feasibility
              </h2>
            </div>
            ...
            <ProjectOverlayCard
              ...
              location="Chicago, IL"
              year="2025"
              description="Comprehensive industrial pre-construction planning, site analysis, and logistics optimization for a heavy manufacturing plant."
            ...
            <div className="lg:col-span-7 space-y-24 lg:space-y-36 flex-1 py-2 lg:py-4 pl-0 lg:pl-12">
              ...
              <div className="space-y-4 min-h-[45vh] flex flex-col justify-end pb-8">
                ...
                <p className="font-titillium text-[15px] sm:text-[17px] lg:text-[18px] 2xl:text-[20px] text-neutral-500 leading-[1.8] max-w-[500px]">
                  We build highly transparent cost estimates based on real-time market data. Our detailed pricing breakdowns enable owners to make informed capital decisions long before construction starts.
                </p>
              </div>
              ...
              <div className="space-y-4 min-h-[45vh] flex flex-col justify-end pb-8">
                ...
                <p className="font-titillium text-[15px] sm:text-[17px] lg:text-[18px] 2xl:text-[20px] text-neutral-500 leading-[1.8] max-w-[500px]">
                  Our estimating and project management experts suggest alternative material options, structural changes, and sourcing methods that reduce cost without compromising quality or design intent.
                </p>
              </div>
              ...
              <div className="space-y-4 min-h-[45vh] flex flex-col justify-end pb-8">
                ...
                <p className="font-titillium text-[15px] sm:text-[17px] lg:text-[18px] 2xl:text-[20px] text-neutral-500 leading-[1.8] max-w-[500px]">
                  Using building information modeling (BIM), we map all plumbing, mechanical, and structural details virtually. This clash detection process avoids field modifications, ensuring smooth building phases.
                </p>
              </div>
